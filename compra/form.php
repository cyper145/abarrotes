                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <select class="custom-select" id="id_proveedor" name="id_proveedor">
                                    ...
                                    <?php if ($proveedor['id'] ==isset($data)? $data['id_proveedor']: ""): ?>
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="date" class="form-control" id="fecha_vencimiento" name="fecha_vencimiento" value="<?=isset($data)? $data['fecha_vencimiento']: "" ?>" required>
                            </div>
                        </div>
